function callCustomerService() {
	window.location.href = 'tel:+908502663737';
}

function sendWhatsAppMessage() {
	var phoneNumber = "+908502663737";
	var message = "Göndermek istediğiniz mesajı yazınız!";
...
// KAR YAĞDIRMA JS BİTİŞ ---

// Vitrin Ürünlerinde Seçilmiş Kategoriyi Gösterme
function showProducts(category) {
	// Tüm ürün kategorilerini gizle
